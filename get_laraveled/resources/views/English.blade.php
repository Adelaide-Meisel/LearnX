...
<div style="border: 2px solid #000; font-family: 'Preahvihear'; font-size: 30px; text-align: left; height: 100px; width: 100%; background-color:#f0ffeb">
        <div>
                ...
                <div style="position:absolute; margin-left: 950px"><!--Grades--><a href={{ route("page.history") }}><img src="/Images/Grade_Icon.jpg" alt="Image cannot load" width="80px" height="80px"></a><!--Image by Freepik--></div>
