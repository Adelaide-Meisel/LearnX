    ...
    <body style="background-color:#fcebff">
        <div style="border: 2px solid #000; font-family: 'Preahvihear'; font-size: 30px; text-align: left; height: 100px; width: 100%; background-color:#f0ffeb">
            <div>
                ...
                <div style="position:absolute; margin-left: 85%; margin-top: 3px"><!--pfp--><a href={{ route("page.profile") }}><img src="/Images/Default_Pfp.png" alt="Image cannot load" width="90px" height="90px"></a></div><!--Image by qalebstudio on Freepik--></div>
                <div style="position:absolute; margin-left: 93%"><!--Home Button--><a href={{ route("page.home") }}><img src="/Images/Home_Icon.png" alt="Image cannot load" width="90px" height="90px"></a></div><!--Image by qalebstudio on Freepik--></div>
                <div></div>
                LearnX      
                <br>
                A+ A+ A+
        ...
        <div>
        A,E,I,O, and U are vowels. Vowels are letters that appear in every word and every syllable(not always all together).
        <br>
        B,C,D,F,G,H,J,K,L,M,N,P,Q,R,S,T,V,W,X,Y, and Z are consonants and 
        <div>
    </body>
</html>