...
{{-- @vite('resources/css/app.css')   --}}
    ...
    <div style="border: 2px solid #000; font-family: 'Preahvihear'; font-size: 30px; text-align: left; height: 100px; width: 100%; background-color:#f0ffeb">
        <div>
            ...
            <div style="position:absolute; margin-left: 85%; margin-top: 3px"><!--pfp--><a href={{ route("page.profile") }}><img src="/Images/Default_Pfp.png" alt="Image cannot load" width="90px" height="90px"></a><!--Image by qalebstudio on Freepik--></div>
            <div style="position:absolute; margin-left: 93%"><!--Home Button--><a href={{ route("page.home") }}><img src="/Images/Home_Icon.png" alt="Image cannot load" width="90px" height="90px"></a><!--Image by qalebstudio on Freepik--></div>
            <div></div>
              LearnX      
            <br>
                A+ A+ A+
        ...
        <br>
        All the other letters work with the vowels to create words
        </div>
    </body>
</html>